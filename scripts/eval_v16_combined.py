"""v16 evaluation — USGS fish community + GeoCLIP + CreelCat features combined.
...
df = pd.read_csv("castline/validation/data/assembled/validation_dataset_v16.csv", low_memory=False)
...
# ── FINAL SUMMARY ──
p(f"\n{'='*60}")
p(f"v16 COMBINED EVALUATION SUMMARY")
p(f"{'='*60}")
...
p("  v15+GeoCLIP32: T=0.428 S=0.474 ST=0.593 LOO=~0.617 (interim)")
