"""v12 honest evaluation: targeted gap-filling, not feature replacement.
...
p()
p("Comparison:")
p("  v10 honest: T=0.424 S=0.477 ST=0.596 LOO=0.575")
p(f"  v12 honest: T={r2_t:.3f} S={r2_s:.3f} ST={r2_st:.3f} LOO={r2_loo:.3f}")
p()
