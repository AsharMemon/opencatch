...
const SPECIES_RANGES: SpeciesRange[] = [
  ...
  },
  {
    ...
    icon: 'fish-outline',
    latRange: { min: 32, max: 55 },
    preferredWater: ['river', 'stream', 'lake'],
    temperateZone: ['cold', 'cool'],
    monthlyActivity: [0.35, 0.40, 0.60, 0.75, 0.85, 0.70, 0.45, 0.40, 0.60, 0.85, 0.70, 0.45],
    habitatDescription: 'Cold spring creeks, undercut banks, deep runs, tailwaters',
  ...
  },
  {
    ...
    icon: 'fish-outline',
    latRange: { min: 42, max: 60 },
    preferredWater: ['lake', 'reservoir'],
    temperateZone: ['cold', 'cool'],
    monthlyActivity: [0.30, 0.35, 0.45, 0.55, 0.65, 0.55, 0.40, 0.35, 0.60, 0.85, 0.70, 0.40],
    habitatDescription: 'Deep cold basins, offshore structure, Canadian shield lakes',
    peakMonths: 'Late winter and September \u2013 November',
  },
  {
    id: 'channel-catfish',
  ...
  },
  {
    ...
    icon: 'fish-outline',
    latRange: { min: 28, max: 46 },
    preferredWater: ['river', 'reservoir', 'lake'],
    temperateZone: ['warm', 'cool'],
    monthlyActivity: [0.05, 0.08, 0.15, 0.35, 0.60, 0.85, 1.0, 0.95, 0.75, 0.45, 0.20, 0.08],
    habitatDescription: 'Deep channels, ledges, outside bends, tailraces',
    peakMonths: 'June \u2013 September',
  },
  {
    id: 'crappie',
  ...
  },
  {
    ...
    icon: 'fish-outline',
    latRange: { min: 30, max: 49 },
    preferredWater: ['lake', 'reservoir', 'pond'],
    temperateZone: ['warm', 'cool'],
    monthlyActivity: [0.15, 0.20, 0.50, 0.85, 0.95, 0.80, 0.65, 0.60, 0.55, 0.70, 0.35, 0.15],
    habitatDescription: 'Clear lakes with brush, docks, standing timber, vegetation edges',
    peakMonths: 'March \u2013 May',
  },
  {
    id: 'white-crappie',
    ...
    icon: 'fish-outline',
    latRange: { min: 30, max: 48 },
    preferredWater: ['reservoir', 'river', 'lake'],
    temperateZone: ['warm', 'cool'],
    monthlyActivity: [0.15, 0.20, 0.45, 0.80, 0.90, 0.78, 0.65, 0.60, 0.55, 0.68, 0.35, 0.15],
    habitatDescription: 'Murky reservoirs, river oxbows, brush piles, creek channels',
    peakMonths: 'March \u2013 May',
  },
  {
    id: 'bluegill',
  ...
  },
  {
    ...
    preferredWater: ['lake', 'pond', 'river', 'reservoir'],
    temperateZone: ['cold', 'cool'],
    monthlyActivity: [0.20, 0.25, 0.45, 0.75, 0.85, 0.75, 0.60, 0.55, 0.65, 0.80, 0.45, 0.20],
    habitatDescription: 'Cool lakes, flats, weed edges, basin transitions, schools near bottom',
    peakMonths: 'April \u2013 June, September \u2013 October',
  },
  {
    id: 'northern-pike',
  ...
  },
  {
    ...
    icon: 'fish-outline',
    latRange: { min: 25, max: 52 },
    preferredWater: ['lake', 'river', 'pond', 'reservoir'],
    temperateZone: ['warm', 'cool'],
    monthlyActivity: [0.10, 0.12, 0.25, 0.45, 0.70, 0.90, 1.0, 0.95, 0.75, 0.50, 0.20, 0.10],
    habitatDescription: 'Shallow flats, muddy bays, backwaters, warm vegetated margins',
    peakMonths: 'May \u2013 September',
  },
  {
    id: 'muskie',
